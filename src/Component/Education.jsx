	...
	>
		...
		<div className="md:w-1/2 bg-[#61CE61] md:bg-base-100  overflow-hidden text-center md:text-left text-xl flex flex-col justify-center items-center">
			<div  className="space-y-4 md:space-y-10">
				<div>
					<h1 className="text-3xl mb-2">Artificial Intelligence & Machine Learning</h1>
					<p>GMR Institute of Technology , Rajam</p>
				</div>
				<div>
					<h1 className="text-3xl mb-2"> Completed Intermediate from</h1>
					<p> Sri Chaitanya Junior College , Rajam</p>
				</div>
			</div>
		</div>
	</div></div>
